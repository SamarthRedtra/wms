...
const formFields = createResource({
	url: "wms.api.get_doctype_fields",
...
const leaveApprovalDetails = createResource({
	url: "wms.api.get_leave_approval_details",
...
function setTotalLeaveDays() {
	...
	const leaveDays = createResource({
		url: "wms.hr.doctype.leave_application.leave_application.get_number_of_leave_days",
		params: {
			employee: employee.data.name,
...
function setLeaveBalance() {
	...
	const leaveBalance = createResource({
		url: "wms.hr.doctype.leave_application.leave_application.get_leave_balance_on",
		params: {
			employee: employee.data.name,
